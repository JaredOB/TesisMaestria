...
A continuación se presentan los desarrollos en la implementación y diseño de controladores basados en el modelo promedio  de los convertidores CD-CD  Buck, Boost y  Buck-Boost. DIchas tecnicas se basan en el uso del modelo promedio de los convertidores mencionados y generar una señal de control $u_av  \in [0,1],$. Existe una variedad de tecnicas que hacen uso de esta señal caracteristica del modelo promedio como lo son las basadas en pasividad, planitud diferencial, Backstepping, entre otras.

Haciendo mencion del control por planitud diferencial, Leopoldo Gil-Antonio  \cite{ref_journal3}
...
[1]L. Gil-Antonio, B. Saldivar, Otniel Portillo-Rodriguez, G. Vazquez-Guzman, and S. Montes, “Trajectory Tracking Control for a Boost Converter Based on the Differential Flatness Property,” IEEE access, vol. 7, pp. 63437–63446, Jan. 2019, doi: https://doi.org/10.1109/access.2019.2916472.
‌
